    ...
    'menu' => [
        ...
        */
        ...
        [
            ...
            'url'  => 'controle-de-utilizacao/create',
            'icon' => 'fas fa-fw fa-user-plus',
        ],
        [
            'text' => 'Minhas Solicitações',
            'url'  => 'controle-de-utilizacao',
        ...
        [
            'text' => 'Veículos',
            'url'  => 'administracao/veiculos',
            'icon' => 'fas fa-fw fa-car',
        ],
        [
            'text' => 'Motoristas',
            'url'  => 'administracao/motoristas',
            'icon' => 'fas fa-fw fa-user-tie',
        ],
        [
            'text' => 'Coordenadores',
            'url'  => 'administracao/coordenador',
