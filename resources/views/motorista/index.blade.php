...
@section('title', 'Motoristas Cadastrados')

@section('content_header')
<a href="{{ route('motoristas.create') }}" class="btn btn-primary float-right"> <i class="fa fa-plus"></i> Adicionar motorista</a>
    <h1>Motoristas Cadastrados</h1>
@stop

@section('content')
    <div class="row">
        @forelse ($motoristas as $i)
        <div class="col-md-4">
        ...
        <div class="modal fade" id="modal{{$i->id}}">
            <form action="{{ route('motoristas.destroy', ['motorista'=>$i->id]) }}" method="post">
                @csrf
                @method('delete')
                ...
                <div class="modal-content">
                    ...
                    Deseja realmente excluir do motorista <b>{{$i->name}}</b>?
