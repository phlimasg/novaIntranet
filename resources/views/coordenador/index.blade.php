...
<a href="{{ route('coordenador.create') }}" class="btn btn-primary float-right"> <i class="fa fa-plus"></i> Adicionar Coordenador</a>
    <h1>Coordenadores Cadastrados</h1>
@stop

@section('content')
    <div class="row">
        @forelse ($coordenadores as $i)
        <div class="col-md-4">
        ...
        <div class="modal fade" id="modal{{$i->id}}">
            <form action="{{ route('coordenador.destroy', ['coordenador'=>$i->id]) }}" method="post">
                @csrf
                @method('delete')
                ...
                <div class="modal-content">
                    ...
                    <h4 class="modal-title">Excluir coordenador?</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    
                    <!-- Modal body -->
                    <div class="modal-body">
                    Deseja realmente excluir do coordenador <b>{{$i->name}}</b>?
